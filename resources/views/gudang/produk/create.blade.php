...
@section('content')
    <div class="container">
        ...
        <form action="{{ route('gudang.produk.store') }}" method="POST" class="animated-form">
            @csrf
            <!-- Nama Produk -->
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input class="form-control input-effect" value="0" type="number" name="stok" id="stok"
                    readonly required>
            </div>
            ...
            <a href="{{ route('gudang.produk.index') }}" class="btn btn-secondary w-100">Kembali</a>
...
<style>
    .title-font {
        font-weight: 600;
        background: linear-gradient(45deg, #006bd7, #63aaf1);
