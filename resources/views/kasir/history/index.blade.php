                ...
                @foreach($transactions as $transaction)
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- Edit Jumlah Produk -->
                            <a href="{{ route('kasir.history.edit', $transaction->id_transaksi) }}" class="btn btn-warning btn-sm">Edit Jumlah</a>

                            <!-- Delete Chart -->
                            <form action="{{ route('kasir.history.delete', $transaction->id_transaksi) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
