    ...
    <div class="main-container">
        <div class="sidebar bg-dark text-white" id="side_nav">
            <div class="header-box text-center py-3">
                <h1 class="fs-4">
                    <span class="text-dark rounded shadow px-2 me-1" id="orange">GUDANG</span>
                    <span class="text-white"><i>Menu Utama</i></span>
                </h1>
            </div>
            <ul class="list-unstyled px-3">
                @php
                    $menuItems = [
                        ...
                        ['route' => 'gudang.produk.index', 'icon' => 'fa-box', 'label' => 'Produk'],
                ...
                @foreach ($menuItems as $item)
                    <li>
                        <a class="text-decoration-none {{ Request::routeIs($item['route']) ? 'active' : '' }}"
